...
class Manajemenijin extends CI_Controller {
...
$this->load->helper('url');
 ...
 if ( $this->session->userdata('akses')==null)
         ...
         
        {
         ...
         $data['dataijinpertim'] = $this->Manajemenijin_Model->getAlldataijinpertim($id_tim);

  
        $this->load->view('template/Header');
        $this->load->view('Manajemenijin',$data);
      ...
      else if ( $this->session->userdata('akses')=='admin')
      {
           ...
           $this->load->model('Manajemenijin_Model');
         $data['dataijinpertim'] = $this->Manajemenijin_Model->getAlldataijin();
